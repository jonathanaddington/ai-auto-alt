...
<img src="docs/images/image-1.png" width="256">
...
# Does it work?
Here are some examples of alt text generated by the plugin:

<img src="docs/images/image-3.png" alt="Map showing a running or walking route marked with a red line and blue dots indicating waypoints or milestones. The route loops around a park area, passing by landmarks such as 'Restructuring Advisors' and 'Anchor Park Basketball Court'. The surrounding area includes 'The Cumberland Presbyterian Church' to the southwest and 'Farragut baseball field 5' to the southeast." width="256">
```
Map showing a running or walking route marked with a red line and blue dots indicating waypoints or milestones. The route loops around a park area, passing by landmarks such as 'Restructuring Advisors' and 'Anchor Park Basketball Court'. The surrounding area includes 'The Cumberland Presbyterian Church' to the southwest and 'Farragut baseball field 5' to the southeast.
```

<img src="docs/images/image-4.png" alt="Illustration of an elderly man with a gentle expression, wearing a long coat and holding a hat in one hand and a walking stick in the other, in a room with a candlestick on a table behind him. The artwork is dated 1862 and signed by Gustave Brion." width="256">
```
Illustration of an elderly man with a gentle expression, wearing a long coat and holding a hat in one hand and a walking stick in the other, in a room with a candlestick on a table behind him. The artwork is dated 1862 and signed by Gustave Brion.
```

<img src="docs/images/image-5.png" alt="Screenshot of a comment thread from news.ycombinator.com where users are expressing concern and well-wishes for someone named Steve. Comments include sentiments like 'God, take the salesman if you please, but not the Woz!!', 'Get well soon, Steve! &lt;3', and discussions about hoping the health issue is not serious. The time is displayed as 7:42 with a battery indicator at 60%." width="256">

```
Screenshot of a comment thread from news.ycombinator.com where users are expressing concern and well-wishes for someone named Steve. Comments include sentiments like "God, take the salesman if you please, but not the Woz!!", "Get well soon, Steve! <3", and discussions about hoping the health issue is not serious. The time is displayed as 7:42 with a battery indicator at 60%.
```

<img src="docs/images/image-6.png" alt="Screenshot of a news article from The Wall Street Journal with the headline 'The Death Rate for Babies in America Rose for the First Time in 20 Years.' The article states that the rate of babies dying in the U.S. increased 3% from 2021 to 2022, according to the CDC. Below the text is a line graph showing U.S. infant deaths per 1,000 live births from 1995 to 2020, indicating a general decline over the years with some fluctuations. The source of the data is the U.S. Centers for Disease Control and Prevention. The image also includes the website's header and indicates a 4-minute read time for the article." width="256">

```
Screenshot of a news article from The Wall Street Journal with the headline "The Death Rate for Babies in America Rose for the First Time in 20 Years." The article states that the rate of babies dying in the U.S. increased 3% from 2021 to 2022, according to the CDC. Below the text is a line graph showing U.S. infant deaths per 1,000 live births from 1995 to 2020, indicating a general decline over the years with some fluctuations. The source of the data is the U.S. Centers for Disease Control and Prevention. The image also includes the website's header and indicates a 4-minute read time for the article.
```

<img src="docs/images/image-3.png" alt="Map showing a running or walking route marked with a red line and blue dots indicating waypoints or milestones. The route loops around a park area, passing by landmarks such as 'Restructuring Advisors' and 'Anchor Park Basketball Court'. The surrounding area includes 'The Cumberland Presbyterian Church' to the southwest and 'Farragut baseball field 5' to the southeast." width="256">

```
A male runner with the number 639 on his race bib is in mid-stride during a road race, wearing a black tank top, shorts, a cap, and running shoes. He appears focused and determined.
```
...
<img src="docs/images/image.png"  width="1024">
